...
### Load dada2 and seqtools
library(dada2); packageVersion("dada2")


### Set working directory!!!
### In RStudio: click "Session" above, -> "Set Working Directory" -> "Choose Directory"
### Choose the folder you put your files in, and click "Open"


### define directory where seq output files are
### DO NOT USE THIS CODE if you are working in binder.
path <- getwd()
list.files(path)
...
# Filter and trim reads, note: 16S V3-V4 region is ~460bp, primers are 16 and 24 bases long
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(290,190), trimLeft=c(16,24),
...
##### THIS SECTION IS ADDED TO CREATE RELATIVE ABUNDANCE TABLES #####
